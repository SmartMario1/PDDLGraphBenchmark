...
(:action transformation7
	:parameters (?n13t6 - type6 ?n14t1 - type1 ?n16t2 - type2 ?n17t1 - type1 ?n21t1 - type1 ?n51t6 - type6 ?n52t1 - type1 ?n54t2 - type2 ?n55t1 - type1 ?n56t1 - type1 	)
	:precondition (and
		(link ?n13t6 ?n14t1)
		(link ?n14t1 ?n13t6)
		(link ?n13t6 ?n16t2)
...
(:action transformation8
	:parameters (?n26t6 - type6 ?n27t1 - type1 ?n31t1 - type1 ?n34t1 - type1 ?n37t1 - type1 ?n39t6 - type6 ?n41t4 - type4 ?n42t2 - type2 ?n45t1 - type1 ?n46t1 - type1 ?n48t2 - type2 	)
	:precondition (and
		(link ?n34t1 ?n26t6)
		(link ?n26t6 ?n34t1)
		(link ?n37t1 ?n26t6)
	...
	:effect (and
		...
		(not (link ?n41t4 ?n46t1))
		(not (link ?n46t1 ?n41t4))
		(not (link ?n41t4 ?n48t2))
		(not (link ?n48t2 ?n41t4))
		(not (link ?n26t6 ?n27t1))
		(not (link ?n27t1 ?n26t6))
		(not (link ?n26t6 ?n31t1))
		(not (link ?n31t1 ?n26t6))
...
(:action transformation9
	:parameters (?n13t6 - type6 ?n15t4 - type4 ?n22t3 - type3 ?n23t1 - type1 ?n25t1 - type1 ?n63t6 - type6 ?n65t4 - type4 ?n68t1 - type1 ?n71t1 - type1 ?n72t2 - type2 	)
	:precondition (and
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n72t2)
...
(:action transformation10
	:parameters (?n1t1 - type1 ?n9t3 - type3 ?n12t1 - type1 ?n39t6 - type6 ?n40t1 - type1 ?n41t4 - type4 ?n42t2 - type2 ?n51t6 - type6 ?n52t1 - type1 ?n56t1 - type1 ?n58t1 - type1 	)
	:precondition (and
		(link ?n1t1 ?n51t6)
		(link ?n51t6 ?n1t1)
		(link ?n39t6 ?n42t2)
	...
	:effect (and
		...
		(not (link ?n51t6 ?n56t1))
		(not (link ?n56t1 ?n51t6))
		(not (link ?n51t6 ?n58t1))
		(not (link ?n58t1 ?n51t6))
		(link ?n1t1 ?n51t6)
		(link ?n51t6 ?n1t1)
		(link ?n39t6 ?n42t2)
		(link ?n42t2 ?n39t6)
...
(:action transformation11
	:parameters (?n4t1 - type1 ?n13t6 - type6 ?n15t4 - type4 ?n17t1 - type1 ?n19t1 - type1 ?n20t1 - type1 ?n63t6 - type6 ?n65t4 - type4 ?n66t2 - type2 ?n67t1 - type1 ?n70t1 - type1 ?n72t2 - type2 	)
	:precondition (and
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n70t1)
	...
	:effect (and
		...
		(not (link ?n13t6 ?n15t4))
		(not (link ?n15t4 ?n13t6))
		(not (link ?n13t6 ?n17t1))
		(not (link ?n17t1 ?n13t6))
		(not (link ?n15t4 ?n19t1))
		(not (link ?n19t1 ?n15t4))
		(not (link ?n15t4 ?n20t1))
		(not (link ?n20t1 ?n15t4))
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
...
(:action transformation12
	:parameters (?n0t6 - type6 ?n9t3 - type3 ?n39t6 - type6 ?n41t4 - type4 ?n46t1 - type1 ?n57t1 - type1 ?n63t6 - type6 ?n64t1 - type1 ?n66t2 - type2 ?n71t1 - type1 ?n74t1 - type1 	)
	:precondition (and
		(link ?n0t6 ?n57t1)
		(link ?n57t1 ?n0t6)
		(link ?n0t6 ?n39t6)
...
(:action transformation13
	:parameters (?n0t6 - type6 ?n3t2 - type2 ?n5t1 - type1 ?n9t3 - type3 ?n12t1 - type1 ?n13t6 - type6 ?n14t1 - type1 ?n16t2 - type2 ?n40t1 - type1 ?n41t4 - type4 	)
	:precondition (and
		(link ?n0t6 ?n16t2)
		(link ?n16t2 ?n0t6)
		(link ?n0t6 ?n13t6)
	...
	:effect (and
		...
		(not (link ?n9t3 ?n13t6))
		(not (link ?n13t6 ?n9t3))
		(not (link ?n41t4 ?n13t6))
		(not (link ?n13t6 ?n41t4))
		(link ?n0t6 ?n13t6)
		(link ?n13t6 ?n0t6)
		(link ?n0t6 ?n16t2)
		(link ?n16t2 ?n0t6)
