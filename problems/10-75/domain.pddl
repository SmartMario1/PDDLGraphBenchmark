...
(:action transformation5
	:parameters (?n2t4 - type4 ?n6t1 - type1 ?n7t1 - type1 ?n9t3 - type3 ?n39t6 - type6 ?n41t4 - type4 ?n46t1 - type1 ?n47t1 - type1 ?n51t6 - type6 ?n56t1 - type1 ?n59t1 - type1 ?n62t1 - type1 	)
	:precondition (and
		(link ?n2t4 ?n7t1)
		(link ?n7t1 ?n2t4)
		(link ?n2t4 ?n6t1)
	...
	:effect (and
		...
		(not (link ?n39t6 ?n47t1))
		(not (link ?n47t1 ?n39t6))
		(not (link ?n39t6 ?n51t6))
		(not (link ?n51t6 ?n39t6))
		(not (link ?n9t3 ?n41t4))
		(not (link ?n41t4 ?n9t3))
...
(:action transformation6
	:parameters (?n39t6 - type6 ?n51t6 - type6 ?n54t2 - type2 ?n55t1 - type1 ?n62t1 - type1 ?n63t6 - type6 ?n64t1 - type1 ?n65t4 - type4 ?n69t1 - type1 ?n72t2 - type2 ?n73t1 - type1 	)
	:precondition (and
		(link ?n64t1 ?n63t6)
		(link ?n63t6 ?n64t1)
		(link ?n65t4 ?n63t6)
...
(:action transformation7
	:parameters (?n11t1 - type1 ?n15t4 - type4 ?n20t1 - type1 ?n22t3 - type3 ?n24t1 - type1 ?n25t1 - type1 ?n51t6 - type6 ?n54t2 - type2 ?n64t1 - type1 ?n65t4 - type4 ?n69t1 - type1 ?n70t1 - type1 	)
	:precondition (and
		(link ?n64t1 ?n54t2)
		(link ?n54t2 ?n64t1)
		(link ?n65t4 ?n69t1)
	...
	:effect (and
		(not (link ?n64t1 ?n54t2))
		(not (link ?n54t2 ?n64t1))
		(not (link ?n65t4 ?n69t1))
		(not (link ?n69t1 ?n65t4))
		(not (link ?n65t4 ?n70t1))
		(not (link ?n70t1 ?n65t4))
		(not (link ?n65t4 ?n51t6))
		(not (link ?n51t6 ?n65t4))
		(not (link ?n11t1 ?n15t4))
		(not (link ?n15t4 ?n11t1))
		(not (link ?n15t4 ?n20t1))
		(not (link ?n20t1 ?n15t4))
		(not (link ?n15t4 ?n22t3))
		(not (link ?n22t3 ?n15t4))
		(not (link ?n15t4 ?n24t1))
		(not (link ?n24t1 ?n15t4))
		(not (link ?n51t6 ?n54t2))
		(not (link ?n54t2 ?n51t6))
		(not (link ?n22t3 ?n25t1))
		(not (link ?n25t1 ?n22t3))
...
(:action transformation8
	:parameters (?n2t4 - type4 ?n6t1 - type1 ?n7t1 - type1 ?n9t3 - type3 ?n10t1 - type1 ?n19t1 - type1 ?n62t1 - type1 ?n63t6 - type6 ?n66t2 - type2 ?n67t1 - type1 ?n68t1 - type1 ?n71t1 - type1 	)
	:precondition (and
		(link ?n2t4 ?n6t1)
		(link ?n6t1 ?n2t4)
		(link ?n2t4 ?n9t3)
	...
	:effect (and
		...
		(not (link ?n9t3 ?n19t1))
		(not (link ?n19t1 ?n9t3))
		(not (link ?n62t1 ?n63t6))
		(not (link ?n63t6 ?n62t1))
		(link ?n2t4 ?n10t1)
		(link ?n10t1 ?n2t4)
		(link ?n2t4 ?n63t6)
		(link ?n63t6 ?n2t4)
...
(:action transformation9
	:parameters (?n26t6 - type6 ?n28t4 - type4 ?n32t1 - type1 ?n33t1 - type1 ?n35t3 - type3 ?n37t1 - type1 ?n63t6 - type6 ?n65t4 - type4 ?n66t2 - type2 ?n67t1 - type1 ?n71t1 - type1 ?n72t2 - type2 	)
	:precondition (and
		(link ?n32t1 ?n28t4)
		(link ?n28t4 ?n32t1)
		(link ?n33t1 ?n28t4)
...
(:action transformation10
	:parameters (?n26t6 - type6 ?n28t4 - type4 ?n33t1 - type1 ?n35t3 - type3 ?n36t1 - type1 ?n38t1 - type1 ?n63t6 - type6 ?n65t4 - type4 ?n66t2 - type2 ?n67t1 - type1 ?n70t1 - type1 ?n72t2 - type2 ?n73t1 - type1 	)
	:precondition (and
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n70t1)
...
(:action transformation11
	:parameters (?n28t4 - type4 ?n32t1 - type1 ?n33t1 - type1 ?n35t3 - type3 ?n36t1 - type1 ?n38t1 - type1 ?n51t6 - type6 ?n52t1 - type1 ?n53t4 - type4 ?n55t1 - type1 ?n56t1 - type1 ?n59t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n28t4)
		(link ?n28t4 ?n32t1)
		(link ?n33t1 ?n28t4)
	...
	:effect (and
		...
		(not (link ?n51t6 ?n53t4))
		(not (link ?n53t4 ?n51t6))
		(not (link ?n51t6 ?n55t1))
		(not (link ?n55t1 ?n51t6))
		(link ?n32t1 ?n53t4)
		(link ?n53t4 ?n32t1)
		(link ?n33t1 ?n28t4)
		(link ?n28t4 ?n33t1)
...
(:action transformation12
	:parameters (?n9t3 - type3 ?n26t6 - type6 ?n27t1 - type1 ?n29t2 - type2 ?n30t1 - type1 ?n34t1 - type1 ?n51t6 - type6 ?n52t1 - type1 ?n53t4 - type4 ?n55t1 - type1 ?n59t1 - type1 	)
	:precondition (and
		(link ?n34t1 ?n26t6)
		(link ?n26t6 ?n34t1)
		(link ?n27t1 ?n9t3)
...
(:action transformation13
	:parameters (?n2t4 - type4 ?n9t3 - type3 ?n29t2 - type2 ?n40t1 - type1 ?n41t4 - type4 ?n46t1 - type1 ?n65t4 - type4 ?n69t1 - type1 ?n70t1 - type1 ?n72t2 - type2 ?n73t1 - type1 	)
	:precondition (and
		(link ?n65t4 ?n69t1)
		(link ?n69t1 ?n65t4)
		(link ?n65t4 ?n70t1)
...
(:action transformation14
	:parameters (?n0t6 - type6 ?n3t2 - type2 ?n4t1 - type1 ?n5t1 - type1 ?n8t1 - type1 ?n10t1 - type1 ?n11t1 - type1 ?n30t1 - type1 ?n31t1 - type1 ?n43t1 - type1 ?n48t2 - type2 ?n49t1 - type1 	)
	:precondition (and
		(link ?n0t6 ?n3t2)
		(link ?n3t2 ?n0t6)
		(link ?n0t6 ?n5t1)
	...
	:effect (and
		...
		(not (link ?n3t2 ?n4t1))
		(not (link ?n4t1 ?n3t2))
		(not (link ?n10t1 ?n30t1))
		(not (link ?n30t1 ?n10t1))
		(not (link ?n48t2 ?n49t1))
		(not (link ?n49t1 ?n48t2))
		(link ?n0t6 ?n8t1)
		(link ?n8t1 ?n0t6)
		(link ?n0t6 ?n30t1)
		(link ?n30t1 ?n0t6)
...
(:action transformation15
	:parameters (?n51t6 - type6 ?n53t4 - type4 ?n59t1 - type1 ?n62t1 - type1 ?n63t6 - type6 ?n64t1 - type1 ?n65t4 - type4 ?n66t2 - type2 ?n67t1 - type1 	)
	:precondition (and
		(link ?n64t1 ?n63t6)
		(link ?n63t6 ?n64t1)
		(link ?n65t4 ?n63t6)
...
(:action transformation16
	:parameters (?n0t6 - type6 ?n4t1 - type1 ?n5t1 - type1 ?n10t1 - type1 ?n26t6 - type6 ?n30t1 - type1 ?n31t1 - type1 ?n48t2 - type2 ?n63t6 - type6 ?n66t2 - type2 ?n67t1 - type1 ?n74t1 - type1 	)
	:precondition (and
		(link ?n0t6 ?n30t1)
		(link ?n30t1 ?n0t6)
		(link ?n0t6 ?n10t1)
	...
	:effect (and
		...
		(not (link ?n66t2 ?n67t1))
		(not (link ?n67t1 ?n66t2))
		(not (link ?n66t2 ?n26t6))
		(not (link ?n26t6 ?n66t2))
		(not (link ?n5t1 ?n48t2))
		(not (link ?n48t2 ?n5t1))
		(not (link ?n74t1 ?n63t6))
		(not (link ?n63t6 ?n74t1))
		(not (link ?n26t6 ?n31t1))
		(not (link ?n31t1 ?n26t6))
		(not (link ?n26t6 ?n63t6))
		(not (link ?n63t6 ?n26t6))
		(link ?n0t6 ?n4t1)
		(link ?n4t1 ?n0t6)
		(link ?n0t6 ?n48t2)
		(link ?n48t2 ?n0t6)
...
(:action transformation17
	:parameters (?n7t1 - type1 ?n28t4 - type4 ?n32t1 - type1 ?n33t1 - type1 ?n35t3 - type3 ?n38t1 - type1 ?n51t6 - type6 ?n52t1 - type1 ?n55t1 - type1 ?n59t1 - type1 ?n62t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n28t4)
		(link ?n28t4 ?n32t1)
		(link ?n33t1 ?n28t4)
