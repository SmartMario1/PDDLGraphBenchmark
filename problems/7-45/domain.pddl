...
(:action transformation6
	:parameters (?n8t4 - type4 ?n10t3 - type3 ?n11t2 - type2 ?n12t1 - type1 ?n15t1 - type1 ?n38t4 - type4 ?n39t1 - type1 ?n40t2 - type2 ?n43t1 - type1 ?n44t1 - type1 	)
	:precondition (and
		(link ?n38t4 ?n39t1)
		(link ?n39t1 ?n38t4)
		(link ?n38t4 ?n40t2)
...
(:action transformation7
	:parameters (?n1t1 - type1 ?n4t1 - type1 ?n8t4 - type4 ?n9t1 - type1 ?n10t3 - type3 ?n13t1 - type1 ?n14t1 - type1 ?n15t1 - type1 ?n31t4 - type4 ?n32t1 - type1 ?n34t2 - type2 ?n35t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n31t4)
		(link ?n31t4 ?n32t1)
		(link ?n1t1 ?n4t1)
...
(:action transformation8
	:parameters (?n3t2 - type2 ?n8t4 - type4 ?n10t3 - type3 ?n11t2 - type2 ?n12t1 - type1 ?n13t1 - type1 ?n16t4 - type4 ?n17t1 - type1 ?n20t1 - type1 ?n21t1 - type1 ?n22t1 - type1 	)
	:precondition (and
		(link ?n3t2 ?n8t4)
		(link ?n8t4 ?n3t2)
		(link ?n3t2 ?n10t3)
	...
	:effect (and
		...
		(not (link ?n8t4 ?n22t1))
		(not (link ?n22t1 ?n8t4))
		(not (link ?n10t3 ?n13t1))
		(not (link ?n13t1 ?n10t3))
...
(:action transformation9
	:parameters (?n3t2 - type2 ?n8t4 - type4 ?n11t2 - type2 ?n16t4 - type4 ?n24t4 - type4 ?n26t2 - type2 ?n27t2 - type2 ?n28t1 - type1 ?n29t1 - type1 	)
	:precondition (and
		(link ?n3t2 ?n8t4)
		(link ?n8t4 ?n3t2)
		(link ?n3t2 ?n16t4)
	...
	:effect (and
		...
		(not (link ?n8t4 ?n11t2))
		(not (link ?n11t2 ?n8t4))
		(not (link ?n11t2 ?n16t4))
		(not (link ?n16t4 ?n11t2))
...
(:action transformation10
	:parameters (?n0t4 - type4 ?n2t3 - type3 ?n3t2 - type2 ?n7t1 - type1 ?n8t4 - type4 ?n18t3 - type3 ?n19t2 - type2 ?n22t1 - type1 ?n23t1 - type1 ?n31t4 - type4 ?n32t1 - type1 ?n34t2 - type2 	)
	:precondition (and
		(link ?n32t1 ?n31t4)
		(link ?n31t4 ?n32t1)
		(link ?n0t4 ?n2t3)
	...
	:effect (and
		...
		(not (link ?n18t3 ?n23t1))
		(not (link ?n23t1 ?n18t3))
		(not (link ?n18t3 ?n19t2))
		(not (link ?n19t2 ?n18t3))
		(link ?n32t1 ?n2t3)
		(link ?n2t3 ?n32t1)
		(link ?n0t4 ?n19t2)
		(link ?n19t2 ?n0t4)
...
(:action transformation11
	:parameters (?n0t4 - type4 ?n8t4 - type4 ?n22t1 - type1 ?n23t1 - type1 ?n34t2 - type2 ?n38t4 - type4 ?n39t1 - type1 ?n40t2 - type2 ?n41t2 - type2 ?n42t1 - type1 ?n44t1 - type1 	)
	:precondition (and
		(link ?n0t4 ?n8t4)
		(link ?n8t4 ?n0t4)
		(link ?n34t2 ?n8t4)
	...
	:effect (and
		...
		(not (link ?n34t2 ?n8t4))
		(not (link ?n8t4 ?n34t2))
		(not (link ?n34t2 ?n23t1))
		(not (link ?n23t1 ?n34t2))
		(not (link ?n38t4 ?n39t1))
		(not (link ?n39t1 ?n38t4))
		(not (link ?n38t4 ?n40t2))
		(not (link ?n40t2 ?n38t4))
