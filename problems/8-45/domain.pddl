...
(:action transformation7
	:parameters (?n0t4 - type4 ?n2t3 - type3 ?n3t2 - type2 ?n4t1 - type1 ?n6t1 - type1 ?n24t4 - type4 ?n25t1 - type1 ?n26t2 - type2 ?n27t2 - type2 ?n29t1 - type1 ?n30t1 - type1 	)
	:precondition (and
		(link ?n0t4 ?n2t3)
		(link ?n2t3 ?n0t4)
		(link ?n0t4 ?n3t2)
...
(:action transformation8
	:parameters (?n0t4 - type4 ?n1t1 - type1 ?n4t1 - type1 ?n5t1 - type1 ?n8t4 - type4 ?n10t3 - type3 ?n11t2 - type2 ?n13t1 - type1 ?n14t1 - type1 ?n24t4 - type4 	)
	:precondition (and
		(link ?n0t4 ?n1t1)
		(link ?n1t1 ?n0t4)
		(link ?n0t4 ?n5t1)
...
(:action transformation9
	:parameters (?n8t4 - type4 ?n9t1 - type1 ?n10t3 - type3 ?n13t1 - type1 ?n15t1 - type1 ?n31t4 - type4 ?n33t2 - type2 ?n34t2 - type2 ?n35t1 - type1 ?n37t1 - type1 	)
	:precondition (and
		(link ?n33t2 ?n31t4)
		(link ?n31t4 ?n33t2)
		(link ?n33t2 ?n37t1)
...
(:action transformation10
	:parameters (?n8t4 - type4 ?n10t3 - type3 ?n11t2 - type2 ?n13t1 - type1 ?n15t1 - type1 ?n16t4 - type4 ?n18t3 - type3 ?n21t1 - type1 ?n31t4 - type4 ?n32t1 - type1 ?n36t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n31t4)
		(link ?n31t4 ?n32t1)
		(link ?n36t1 ?n31t4)
...
(:action transformation11
	:parameters (?n18t3 - type3 ?n24t4 - type4 ?n34t2 - type2 ?n36t1 - type1 ?n37t1 - type1 ?n38t4 - type4 ?n39t1 - type1 ?n41t2 - type2 ?n42t1 - type1 ?n43t1 - type1 	)
	:precondition (and
		(link ?n34t2 ?n24t4)
		(link ?n24t4 ?n34t2)
		(link ?n34t2 ?n18t3)
	...
	:effect (and
		(not (link ?n34t2 ?n24t4))
		(not (link ?n24t4 ?n34t2))
		(not (link ?n34t2 ?n18t3))
		(not (link ?n18t3 ?n34t2))
		(not (link ?n36t1 ?n18t3))
		(not (link ?n18t3 ?n36t1))
		(not (link ?n37t1 ?n24t4))
		(not (link ?n24t4 ?n37t1))
		(not (link ?n38t4 ?n39t1))
		(not (link ?n39t1 ?n38t4))
		(not (link ?n38t4 ?n41t2))
		(not (link ?n41t2 ?n38t4))
...
(:action transformation12
	:parameters (?n0t4 - type4 ?n1t1 - type1 ?n4t1 - type1 ?n10t3 - type3 ?n14t1 - type1 ?n15t1 - type1 ?n17t1 - type1 ?n18t3 - type3 ?n25t1 - type1 ?n44t1 - type1 	)
	:precondition (and
		(link ?n0t4 ?n25t1)
		(link ?n25t1 ?n0t4)
		(link ?n0t4 ?n1t1)
	...
	:effect (and
		...
		(not (link ?n10t3 ?n14t1))
		(not (link ?n14t1 ?n10t3))
		(not (link ?n10t3 ?n18t3))
		(not (link ?n18t3 ?n10t3))
		(not (link ?n44t1 ?n18t3))
		(not (link ?n18t3 ?n44t1))
		(link ?n0t4 ?n25t1)
		(link ?n25t1 ?n0t4)
		(link ?n0t4 ?n18t3)
		(link ?n18t3 ?n0t4)
...
(:action transformation13
	:parameters (?n0t4 - type4 ?n10t3 - type3 ?n16t4 - type4 ?n18t3 - type3 ?n21t1 - type1 ?n24t4 - type4 ?n25t1 - type1 ?n29t1 - type1 ?n31t4 - type4 ?n32t1 - type1 ?n33t2 - type2 ?n37t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n31t4)
		(link ?n31t4 ?n32t1)
		(link ?n33t2 ?n31t4)
	...
	:effect (and
		...
		(not (link ?n33t2 ?n31t4))
		(not (link ?n31t4 ?n33t2))
		(not (link ?n33t2 ?n29t1))
		(not (link ?n29t1 ?n33t2))
		(not (link ?n0t4 ?n18t3))
		(not (link ?n18t3 ?n0t4))
		(not (link ?n0t4 ?n10t3))
		(not (link ?n10t3 ?n0t4))
		(not (link ?n37t1 ?n24t4))
		(not (link ?n24t4 ?n37t1))
		(not (link ?n10t3 ?n25t1))
		(not (link ?n25t1 ?n10t3))
		(not (link ?n16t4 ?n24t4))
		(not (link ?n24t4 ?n16t4))
		(not (link ?n16t4 ?n21t1))
		(not (link ?n21t1 ?n16t4))
		(not (link ?n16t4 ?n31t4))
		(not (link ?n31t4 ?n16t4))
		(not (link ?n18t3 ?n24t4))
		(not (link ?n24t4 ?n18t3))
		(link ?n32t1 ?n29t1)
		(link ?n29t1 ?n32t1)
		(link ?n33t2 ?n24t4)
		(link ?n24t4 ?n33t2)
