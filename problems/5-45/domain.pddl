...
(:action transformation4
	:parameters (?n24t4 - type4 ?n25t1 - type1 ?n26t2 - type2 ?n27t2 - type2 ?n28t1 - type1 ?n29t1 - type1 ?n31t4 - type4 ?n32t1 - type1 ?n33t2 - type2 ?n34t2 - type2 ?n35t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n31t4)
		(link ?n31t4 ?n32t1)
		(link ?n33t2 ?n31t4)
...
(:action transformation5
	:parameters (?n0t4 - type4 ?n2t3 - type3 ?n3t2 - type2 ?n4t1 - type1 ?n5t1 - type1 ?n8t4 - type4 ?n9t1 - type1 ?n11t2 - type2 ?n12t1 - type1 ?n13t1 - type1 	)
	:precondition (and
		(link ?n0t4 ?n2t3)
		(link ?n2t3 ?n0t4)
		(link ?n0t4 ?n3t2)
...
(:action transformation6
	:parameters (?n24t4 - type4 ?n25t1 - type1 ?n27t2 - type2 ?n29t1 - type1 ?n38t4 - type4 ?n39t1 - type1 ?n40t2 - type2 ?n41t2 - type2 ?n42t1 - type1 ?n43t1 - type1 ?n44t1 - type1 	)
	:precondition (and
		(link ?n38t4 ?n27t2)
		(link ?n27t2 ?n38t4)
		(link ?n38t4 ?n41t2)
	...
	:effect (and
		(not (link ?n38t4 ?n27t2))
		(not (link ?n27t2 ?n38t4))
		(not (link ?n38t4 ?n41t2))
		(not (link ?n41t2 ?n38t4))
		...
		(not (link ?n38t4 ?n40t2))
		(not (link ?n40t2 ?n38t4))
		(not (link ?n39t1 ?n24t4))
		(not (link ?n24t4 ?n39t1))
		(not (link ?n40t2 ?n25t1))
		(not (link ?n25t1 ?n40t2))
		(not (link ?n41t2 ?n42t1))
		(not (link ?n42t1 ?n41t2))
		(not (link ?n43t1 ?n24t4))
		(not (link ?n24t4 ?n43t1))
		(not (link ?n44t1 ?n27t2))
		(not (link ?n27t2 ?n44t1))
		(not (link ?n24t4 ?n29t1))
		(not (link ?n29t1 ?n24t4))
		(link ?n38t4 ?n27t2)
		(link ?n27t2 ?n38t4)
...
(:action transformation7
	:parameters (?n8t4 - type4 ?n9t1 - type1 ?n11t2 - type2 ?n12t1 - type1 ?n13t1 - type1 ?n24t4 - type4 ?n27t2 - type2 ?n38t4 - type4 ?n40t2 - type2 ?n41t2 - type2 	)
	:precondition (and
		(link ?n38t4 ?n27t2)
		(link ?n27t2 ?n38t4)
		(link ?n38t4 ?n24t4)
	...
	:effect (and
		...
		(not (link ?n8t4 ?n13t1))
		(not (link ?n13t1 ?n8t4))
		(not (link ?n41t2 ?n24t4))
		(not (link ?n24t4 ?n41t2))
		(not (link ?n11t2 ?n12t1))
		(not (link ?n12t1 ?n11t2))
		(not (link ?n40t2 ?n27t2))
		(not (link ?n27t2 ?n40t2))
		(link ?n38t4 ?n27t2)
		(link ?n27t2 ?n38t4)
		(link ?n38t4 ?n41t2)
		(link ?n41t2 ?n38t4)
