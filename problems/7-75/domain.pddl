...
(:action transformation6
	:parameters (?n51t6 - type6 ?n52t1 - type1 ?n53t4 - type4 ?n54t2 - type2 ?n55t1 - type1 ?n56t1 - type1 ?n57t1 - type1 ?n59t1 - type1 ?n60t2 - type2 ?n61t1 - type1 ?n62t1 - type1 	)
	:precondition (and
		(link ?n51t6 ?n52t1)
		(link ?n52t1 ?n51t6)
		(link ?n51t6 ?n53t4)
...
(:action transformation7
	:parameters (?n0t6 - type6 ?n1t1 - type1 ?n3t2 - type2 ?n5t1 - type1 ?n8t1 - type1 ?n11t1 - type1 ?n26t6 - type6 ?n27t1 - type1 ?n28t4 - type4 ?n29t2 - type2 ?n30t1 - type1 ?n37t1 - type1 	)
	:precondition (and
		(link ?n0t6 ?n1t1)
		(link ?n1t1 ?n0t6)
		(link ?n0t6 ?n3t2)
...
(:action transformation8
	:parameters (?n28t4 - type4 ?n33t1 - type1 ?n35t3 - type3 ?n36t1 - type1 ?n38t1 - type1 ?n63t6 - type6 ?n65t4 - type4 ?n66t2 - type2 ?n71t1 - type1 ?n72t2 - type2 	)
	:precondition (and
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n72t2)
...
(:action transformation9
	:parameters (?n26t6 - type6 ?n27t1 - type1 ?n28t4 - type4 ?n31t1 - type1 ?n32t1 - type1 ?n33t1 - type1 ?n35t3 - type3 ?n36t1 - type1 ?n37t1 - type1 ?n38t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n28t4)
		(link ?n28t4 ?n32t1)
		(link ?n33t1 ?n28t4)
...
(:action transformation10
	:parameters (?n25t1 - type1 ?n26t6 - type6 ?n28t4 - type4 ?n31t1 - type1 ?n32t1 - type1 ?n33t1 - type1 ?n34t1 - type1 ?n35t3 - type3 ?n36t1 - type1 ?n38t1 - type1 ?n54t2 - type2 ?n55t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n28t4)
		(link ?n28t4 ?n32t1)
		(link ?n33t1 ?n28t4)
	...
	:effect (and
		...
		(not (link ?n54t2 ?n55t1))
		(not (link ?n55t1 ?n54t2))
		(not (link ?n54t2 ?n25t1))
		(not (link ?n25t1 ?n54t2))
		(not (link ?n26t6 ?n28t4))
		(not (link ?n28t4 ?n26t6))
		(not (link ?n26t6 ?n31t1))
		(not (link ?n31t1 ?n26t6))
...
(:action transformation11
	:parameters (?n26t6 - type6 ?n29t2 - type2 ?n30t1 - type1 ?n31t1 - type1 ?n35t3 - type3 ?n39t6 - type6 ?n40t1 - type1 ?n41t4 - type4 ?n43t1 - type1 ?n47t1 - type1 ?n50t1 - type1 ?n55t1 - type1 	)
	:precondition (and
		(link ?n35t3 ?n26t6)
		(link ?n26t6 ?n35t3)
		(link ?n35t3 ?n55t1)
	...
	:effect (and
		(not (link ?n35t3 ?n26t6))
		(not (link ?n26t6 ?n35t3))
		(not (link ?n35t3 ?n55t1))
		(not (link ?n55t1 ?n35t3))
		(not (link ?n39t6 ?n40t1))
		(not (link ?n40t1 ?n39t6))
		(not (link ?n39t6 ?n47t1))
		(not (link ?n47t1 ?n39t6))
		(not (link ?n39t6 ?n43t1))
		(not (link ?n43t1 ?n39t6))
		(not (link ?n39t6 ?n41t4))
		(not (link ?n41t4 ?n39t6))
		(not (link ?n41t4 ?n50t1))
		(not (link ?n50t1 ?n41t4))
		(not (link ?n26t6 ?n29t2))
		(not (link ?n29t2 ?n26t6))
		(not (link ?n26t6 ?n31t1))
		(not (link ?n31t1 ?n26t6))
