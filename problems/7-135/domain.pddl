...
(:action transformation6
	:parameters (?n0t9 - type9 ?n2t5 - type5 ?n6t1 - type1 ?n9t3 - type3 ?n12t1 - type1 ?n22t1 - type1 ?n46t9 - type9 ?n48t5 - type5 ?n49t2 - type2 ?n54t1 - type1 ?n64t2 - type2 ?n67t1 - type1 	)
	:precondition (and
		(link ?n64t2 ?n46t9)
		(link ?n46t9 ?n64t2)
		(link ?n64t2 ?n67t1)
...
(:action transformation7
	:parameters (?n0t9 - type9 ?n1t3 - type3 ?n8t1 - type1 ?n11t1 - type1 ?n14t1 - type1 ?n20t1 - type1 ?n113t9 - type9 ?n114t3 - type3 ?n118t1 - type1 ?n124t1 - type1 ?n127t1 - type1 ?n133t1 - type1 	)
	:precondition (and
		(link ?n0t9 ?n1t3)
		(link ?n1t3 ?n0t9)
		(link ?n0t9 ?n8t1)
...
(:action transformation8
	:parameters (?n2t5 - type5 ?n7t4 - type4 ?n48t5 - type5 ?n52t1 - type1 ?n53t4 - type4 ?n63t1 - type1 ?n69t9 - type9 ?n72t2 - type2 ?n73t1 - type1 ?n77t1 - type1 ?n80t1 - type1 	)
	:precondition (and
		(link ?n2t5 ?n7t4)
		(link ?n7t4 ?n2t5)
		(link ?n2t5 ?n48t5)
...
(:action transformation9
	:parameters (?n0t9 - type9 ?n15t1 - type1 ?n23t9 - type9 ?n25t5 - type5 ?n31t1 - type1 ?n48t5 - type5 ?n69t9 - type9 ?n70t3 - type3 ?n72t2 - type2 ?n73t1 - type1 ?n80t1 - type1 ?n89t1 - type1 	)
	:precondition (and
		(link ?n0t9 ?n15t1)
		(link ?n15t1 ?n0t9)
		(link ?n0t9 ?n48t5)
	...
	:effect (and
		...
		(not (link ?n69t9 ?n80t1))
		(not (link ?n80t1 ?n69t9))
		(not (link ?n70t3 ?n89t1))
		(not (link ?n89t1 ?n70t3))
		(not (link ?n72t2 ?n73t1))
		(not (link ?n73t1 ?n72t2))
		(not (link ?n48t5 ?n23t9))
		(not (link ?n23t9 ?n48t5))
...
(:action transformation10
	:parameters (?n1t3 - type3 ?n5t1 - type1 ?n14t1 - type1 ?n23t9 - type9 ?n26t2 - type2 ?n34t1 - type1 ?n39t1 - type1 ?n46t9 - type9 ?n47t3 - type3 ?n48t5 - type5 ?n49t2 - type2 ?n52t1 - type1 	)
	:precondition (and
		(link ?n1t3 ?n34t1)
		(link ?n34t1 ?n1t3)
		(link ?n1t3 ?n23t9)
	...
	:effect (and
		...
		(not (link ?n14t1 ?n23t9))
		(not (link ?n23t9 ?n14t1))
		(not (link ?n47t3 ?n46t9))
		(not (link ?n46t9 ?n47t3))
		(not (link ?n47t3 ?n48t5))
		(not (link ?n48t5 ?n47t3))
		(not (link ?n48t5 ?n52t1))
		(not (link ?n52t1 ?n48t5))
		(not (link ?n48t5 ?n49t2))
		(not (link ?n49t2 ?n48t5))
		(not (link ?n46t9 ?n23t9))
		(not (link ?n23t9 ?n46t9))
		(not (link ?n23t9 ?n26t2))
		(not (link ?n26t2 ?n23t9))
		(link ?n1t3 ?n34t1)
		(link ?n34t1 ?n1t3)
		(link ?n1t3 ?n49t2)
		(link ?n49t2 ?n1t3)
