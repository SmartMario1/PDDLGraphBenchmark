...
(:action transformation8
	:parameters (?n0t4 - type4 ?n1t1 - type1 ?n5t1 - type1 ?n9t1 - type1 ?n14t1 - type1 ?n16t4 - type4 ?n24t4 - type4 ?n27t2 - type2 ?n29t1 - type1 ?n41t2 - type2 	)
	:precondition (and
		(link ?n0t4 ?n1t1)
		(link ?n1t1 ?n0t4)
		(link ?n0t4 ?n16t4)
	...
	:effect (and
		...
		(not (link ?n5t1 ?n16t4))
		(not (link ?n16t4 ?n5t1))
		(not (link ?n41t2 ?n27t2))
		(not (link ?n27t2 ?n41t2))
		(not (link ?n14t1 ?n24t4))
		(not (link ?n24t4 ?n14t1))
...
(:action transformation9
	:parameters (?n0t4 - type4 ?n1t1 - type1 ?n2t3 - type3 ?n3t2 - type2 ?n4t1 - type1 ?n5t1 - type1 ?n31t4 - type4 ?n32t1 - type1 ?n33t2 - type2 ?n34t2 - type2 ?n35t1 - type1 ?n37t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n31t4)
		(link ?n31t4 ?n32t1)
		(link ?n33t2 ?n31t4)
...
(:action transformation10
	:parameters (?n0t4 - type4 ?n2t3 - type3 ?n3t2 - type2 ?n4t1 - type1 ?n6t1 - type1 ?n16t4 - type4 ?n17t1 - type1 ?n18t3 - type3 ?n19t2 - type2 ?n22t1 - type1 ?n23t1 - type1 	)
	:precondition (and
		(link ?n0t4 ?n2t3)
		(link ?n2t3 ?n0t4)
		(link ?n0t4 ?n3t2)
...
(:action transformation11
	:parameters (?n2t3 - type3 ?n3t2 - type2 ?n4t1 - type1 ?n7t1 - type1 ?n18t3 - type3 ?n21t1 - type1 ?n38t4 - type4 ?n39t1 - type1 ?n40t2 - type2 ?n41t2 - type2 ?n42t1 - type1 ?n44t1 - type1 	)
	:precondition (and
		(link ?n2t3 ?n7t1)
		(link ?n7t1 ?n2t3)
		(link ?n2t3 ?n18t3)
...
(:action transformation12
	:parameters (?n0t4 - type4 ?n2t3 - type3 ?n6t1 - type1 ?n7t1 - type1 ?n16t4 - type4 ?n17t1 - type1 ?n19t2 - type2 ?n20t1 - type1 ?n22t1 - type1 ?n23t1 - type1 ?n35t1 - type1 	)
	:precondition (and
		(link ?n0t4 ?n16t4)
		(link ?n16t4 ?n0t4)
		(link ?n0t4 ?n23t1)
	...
	:effect (and
		...
		(not (link ?n16t4 ?n19t2))
		(not (link ?n19t2 ?n16t4))
		(not (link ?n16t4 ?n22t1))
		(not (link ?n22t1 ?n16t4))
		(not (link ?n19t2 ?n20t1))
		(not (link ?n20t1 ?n19t2))
		(link ?n0t4 ?n6t1)
		(link ?n6t1 ?n0t4)
...
(:action transformation13
	:parameters (?n2t3 - type3 ?n7t1 - type1 ?n8t4 - type4 ?n11t2 - type2 ?n12t1 - type1 ?n13t1 - type1 ?n16t4 - type4 ?n20t1 - type1 ?n22t1 - type1 ?n24t4 - type4 	)
	:precondition (and
		(link ?n2t3 ?n7t1)
		(link ?n7t1 ?n2t3)
		(link ?n2t3 ?n22t1)
	...
	:effect (and
		...
		(not (link ?n8t4 ?n24t4))
		(not (link ?n24t4 ?n8t4))
		(not (link ?n11t2 ?n24t4))
		(not (link ?n24t4 ?n11t2))
...
(:action transformation14
	:parameters (?n0t4 - type4 ?n1t1 - type1 ?n5t1 - type1 ?n6t1 - type1 ?n16t4 - type4 ?n19t2 - type2 ?n20t1 - type1 ?n25t1 - type1 ?n28t1 - type1 ?n35t1 - type1 	)
	:precondition (and
		(link ?n0t4 ?n5t1)
		(link ?n5t1 ?n0t4)
		(link ?n0t4 ?n35t1)
	...
	:effect (and
		...
		(not (link ?n16t4 ?n20t1))
		(not (link ?n20t1 ?n16t4))
		(not (link ?n25t1 ?n28t1))
		(not (link ?n28t1 ?n25t1))
		(link ?n0t4 ?n16t4)
		(link ?n16t4 ?n0t4)
		(link ?n0t4 ?n28t1)
		(link ?n28t1 ?n0t4)
...
(:action transformation15
	:parameters (?n20t1 - type1 ?n31t4 - type4 ?n32t1 - type1 ?n35t1 - type1 ?n38t4 - type4 ?n39t1 - type1 ?n40t2 - type2 ?n41t2 - type2 ?n42t1 - type1 ?n43t1 - type1 ?n44t1 - type1 	)
	:precondition (and
		(link ?n32t1 ?n31t4)
		(link ?n31t4 ?n32t1)
		(link ?n35t1 ?n20t1)
	...
	:effect (and
		(not (link ?n32t1 ?n31t4))
		(not (link ?n31t4 ?n32t1))
		(not (link ?n35t1 ?n20t1))
		(not (link ?n20t1 ?n35t1))
		(not (link ?n38t4 ?n39t1))
		(not (link ?n39t1 ?n38t4))
		(not (link ?n38t4 ?n40t2))
		(not (link ?n40t2 ?n38t4))
...
(:action transformation16
	:parameters (?n5t1 - type1 ?n9t1 - type1 ?n26t2 - type2 ?n30t1 - type1 ?n38t4 - type4 ?n39t1 - type1 ?n40t2 - type2 ?n41t2 - type2 ?n43t1 - type1 ?n44t1 - type1 	)
	:precondition (and
		(link ?n5t1 ?n39t1)
		(link ?n39t1 ?n5t1)
		(link ?n38t4 ?n41t2)
	...
	:effect (and
		...
		(not (link ?n40t2 ?n43t1))
		(not (link ?n43t1 ?n40t2))
		(not (link ?n40t2 ?n41t2))
		(not (link ?n41t2 ?n40t2))
		(not (link ?n9t1 ?n26t2))
		(not (link ?n26t2 ?n9t1))
...
(:action transformation17
	:parameters (?n0t4 - type4 ?n2t3 - type3 ?n6t1 - type1 ?n7t1 - type1 ?n8t4 - type4 ?n12t1 - type1 ?n16t4 - type4 ?n19t2 - type2 ?n23t1 - type1 ?n24t4 - type4 ?n30t1 - type1 ?n38t4 - type4 ?n42t1 - type1 	)
	:precondition (and
		(link ?n0t4 ?n23t1)
		(link ?n23t1 ?n0t4)
		(link ?n0t4 ?n16t4)
	...
	:effect (and
		...
		(not (link ?n38t4 ?n30t1))
		(not (link ?n30t1 ?n38t4))
		(not (link ?n6t1 ?n19t2))
		(not (link ?n19t2 ?n6t1))
		(not (link ?n8t4 ?n24t4))
		(not (link ?n24t4 ?n8t4))
