...
(:action transformation8
	:parameters (?n51t6 - type6 ?n52t1 - type1 ?n53t4 - type4 ?n60t2 - type2 ?n61t1 - type1 ?n62t1 - type1 ?n63t6 - type6 ?n65t4 - type4 ?n69t1 - type1 ?n70t1 - type1 ?n71t1 - type1 ?n72t2 - type2 	)
	:precondition (and
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n69t1)
	...
	:effect (and
		...
		(not (link ?n51t6 ?n62t1))
		(not (link ?n62t1 ?n51t6))
		(not (link ?n53t4 ?n60t2))
		(not (link ?n60t2 ?n53t4))
		(not (link ?n60t2 ?n61t1))
		(not (link ?n61t1 ?n60t2))
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n72t2)
		(link ?n72t2 ?n65t4)
...
(:action transformation9
	:parameters (?n13t6 - type6 ?n14t1 - type1 ?n15t4 - type4 ?n16t2 - type2 ?n17t1 - type1 ?n21t1 - type1 ?n63t6 - type6 ?n65t4 - type4 ?n68t1 - type1 ?n69t1 - type1 ?n70t1 - type1 ?n71t1 - type1 ?n74t1 - type1 	)
	:precondition (and
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n69t1)
	...
	:effect (and
		...
		(not (link ?n74t1 ?n63t6))
		(not (link ?n63t6 ?n74t1))
		(not (link ?n13t6 ?n14t1))
		(not (link ?n14t1 ?n13t6))
		(not (link ?n13t6 ?n15t4))
		(not (link ?n15t4 ?n13t6))
		(not (link ?n13t6 ?n16t2))
		(not (link ?n16t2 ?n13t6))
		(not (link ?n13t6 ?n21t1))
		(not (link ?n21t1 ?n13t6))
		(not (link ?n16t2 ?n17t1))
		(not (link ?n17t1 ?n16t2))
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n70t1)
		(link ?n70t1 ?n65t4)
...
(:action transformation10
	:parameters (?n26t6 - type6 ?n27t1 - type1 ?n29t2 - type2 ?n30t1 - type1 ?n31t1 - type1 ?n37t1 - type1 ?n63t6 - type6 ?n65t4 - type4 ?n69t1 - type1 ?n70t1 - type1 ?n74t1 - type1 	)
	:precondition (and
		(link ?n65t4 ?n63t6)
		(link ?n63t6 ?n65t4)
		(link ?n65t4 ?n69t1)
...
(:action transformation11
	:parameters (?n0t6 - type6 ?n2t4 - type4 ?n6t1 - type1 ?n9t3 - type3 ?n13t6 - type6 ?n16t2 - type2 ?n18t1 - type1 ?n21t1 - type1 ?n56t1 - type1 ?n60t2 - type2 ?n61t1 - type1 	)
	:precondition (and
		(link ?n0t6 ?n6t1)
		(link ?n6t1 ?n0t6)
		(link ?n0t6 ?n13t6)
	...
	:effect (and
		...
		(not (link ?n13t6 ?n21t1))
		(not (link ?n21t1 ?n13t6))
		(not (link ?n13t6 ?n18t1))
		(not (link ?n18t1 ?n13t6))
		(not (link ?n13t6 ?n16t2))
		(not (link ?n16t2 ?n13t6))
		(not (link ?n56t1 ?n60t2))
		(not (link ?n60t2 ?n56t1))
		(not (link ?n60t2 ?n61t1))
		(not (link ?n61t1 ?n60t2))
		(link ?n0t6 ?n6t1)
		(link ?n6t1 ?n0t6)
...
(:action transformation12
	:parameters (?n26t6 - type6 ?n28t4 - type4 ?n29t2 - type2 ?n30t1 - type1 ?n31t1 - type1 ?n51t6 - type6 ?n52t1 - type1 ?n54t2 - type2 ?n55t1 - type1 ?n62t1 - type1 	)
	:precondition (and
		(link ?n51t6 ?n52t1)
		(link ?n52t1 ?n51t6)
		(link ?n51t6 ?n54t2)
...
(:action transformation13
	:parameters (?n0t6 - type6 ?n1t1 - type1 ?n2t4 - type4 ?n13t6 - type6 ?n29t2 - type2 ?n56t1 - type1 ?n63t6 - type6 ?n64t1 - type1 ?n66t2 - type2 ?n67t1 - type1 ?n68t1 - type1 	)
	:precondition (and
		(link ?n0t6 ?n2t4)
		(link ?n2t4 ?n0t6)
		(link ?n0t6 ?n29t2)
...
(:action transformation14
	:parameters (?n11t1 - type1 ?n26t6 - type6 ?n27t1 - type1 ?n34t1 - type1 ?n37t1 - type1 ?n63t6 - type6 ?n66t2 - type2 ?n67t1 - type1 ?n68t1 - type1 ?n71t1 - type1 ?n74t1 - type1 	)
	:precondition (and
		(link ?n34t1 ?n26t6)
		(link ?n26t6 ?n34t1)
		(link ?n66t2 ?n63t6)
	...
	:effect (and
		...
		(not (link ?n74t1 ?n63t6))
		(not (link ?n63t6 ?n74t1))
		(not (link ?n11t1 ?n26t6))
		(not (link ?n26t6 ?n11t1))
		(not (link ?n26t6 ?n27t1))
		(not (link ?n27t1 ?n26t6))
		(link ?n34t1 ?n27t1)
		(link ?n27t1 ?n34t1)
...
(:action transformation15
	:parameters (?n3t2 - type2 ?n26t6 - type6 ?n28t4 - type4 ?n34t1 - type1 ?n35t3 - type3 ?n56t1 - type1 ?n63t6 - type6 ?n64t1 - type1 ?n65t4 - type4 ?n69t1 - type1 ?n70t1 - type1 ?n71t1 - type1 	)
	:precondition (and
		(link ?n64t1 ?n63t6)
		(link ?n63t6 ?n64t1)
		(link ?n65t4 ?n63t6)
	...
	:effect (and
		...
		(not (link ?n71t1 ?n63t6))
		(not (link ?n63t6 ?n71t1))
		(not (link ?n56t1 ?n26t6))
		(not (link ?n26t6 ?n56t1))
		(link ?n64t1 ?n28t4)
		(link ?n28t4 ?n64t1)
		(link ?n65t4 ?n35t3)
		(link ?n35t3 ?n65t4)
